    ...
    prices: [
      {
        ...
        travelers: {
          adults: currentRoom?.infos?.adults || adults,
          childrens: currentRoom?.infos?.children || children,
          ages: [],
        },
      },
    ],
    infos: {
      adults: parseInt(currentRoom?.infos?.adults || adults),
      children: parseInt(currentRoom?.infos?.children || children),
