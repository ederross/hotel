  ...
  return (
    <>
      ...
      <div className={styles.mobTimelineCount}>
        ...
        <span className={styles.mobTimelineTitle}>Sua reserva vence em:</span>
      ...
      <div className={styles.cardDetailsResultContainer} style={{ padding: 0 }}>
            ...
            >
              ...
              {ctaSelected === index && (
                <div style={{ padding: 24 }}>
                  ...
                  >
                    <div className={styles.holderCardDetails}>
                      <span className={styles.holderTitle}>{t('agency')}</span>
                      <span className={styles.holderDescription}>
                        {item.bankName}
                      </span>
                    </div>
                    <div className={styles.holderCardDetails}>
                      <span className={styles.holderTitle}>{t('account')}</span>
                      <span className={styles.holderDescription}>
                        {item.account}
                      </span>
                    </div>
                  ...
                  <div className={styles.holderCardDetails}>
                    <span className={styles.holderTitle}>{t('favored')}</span>
                    <span className={styles.holderDescription}>João Gomes</span>
                  </div>
                  <div className={styles.holderCardDetails}>
      ...
      <div className={styles.mobReturnFeedbackContainer}>
        ...
        <div style={{ marginBottom: 32 }}>
          <Link href="https://">
            <a target="_blank" className={styles.localizationTitle}>
              {t('bookLocale')}
            </a>
          </Link>
        </div>
